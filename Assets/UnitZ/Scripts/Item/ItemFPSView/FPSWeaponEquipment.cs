...
public class FPSWeaponEquipment : FPSItemEquipment
{
    ...
    public override void OnAction()
    {
        ...
        if (Ammo > 0 || InfinityAmmo)
        {
            ...
            if (character != null)
            {
                character.DoDamageByItemIndex(fpsController.PlayerView.FPSCamera.RayPointer.transform.position, fpsController.PlayerView.FPSCamera.RayPointer.transform.forward, ItemIndex, seed);
            }
        }
        base.OnAction();
